  ...
  render: function () {
    return (
      <div className="chat-box" ref="root">
        <div className="chat-header ui-widget-header" style="text-Align:cente;r"><h2>Chat with other EventFinder users</h2></div>
        <div className="chat-content-wrapper row"style="text-Align:center">
